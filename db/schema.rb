...
ActiveRecord::Schema.define(version: 2020_07_08_071442) do
  ...
  create_table "follow_members", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "follower_id"
    t.integer "followed_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["followed_id"], name: "index_follow_members_on_followed_id"
    t.index ["follower_id", "followed_id"], name: "index_follow_members_on_follower_id_and_followed_id", unique: true
    t.index ["follower_id"], name: "index_follow_members_on_follower_id"
  end
  ...
  create_table "player_positions", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "player_id"
  ...
  create_table "team_positions", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "team_id"
    t.bigint "position_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
