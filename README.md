...
問題提起
「バレーボールを続けたいけど周りにチームがない。バレーボールをしている知り合いもいない。」
「チームを作ったのはいいけどポジションに合う人材が足りない。」
バレーボールをするための環境を求めるプレイヤーと人材が不足しているチームを繋ぐマッチングサイトです。
私は小学校からバレーボールをしており、今も地元の長野県では続けているのですが、もし新しい地方に転勤や転職となった際、近くに友人がいない場合はバレーボールを続けることができない。またスポーツ系のマッチングアプリはあるものの、バレーボールというスポーツに特化したマッチングアプリはないという部分に着目し、新しい場所でも気軽にバレーボール仲間を作りスポーツを楽しみたいという想いでアプリを開発しました。

期待される結果
・プレイヤーはチームとマッチングすることでバレーボールをするための環境を手に入れる事ができる。
・チームはプレイヤーとマッチングすることで必要な人材を確保する事ができる。
